...
\newcommand{\DelTitle}{Target enterprise architecture}
...
\newcommand{\DelDate}{26 Feb 2021}
\newcommand{\DelInitiative}{Initiative for Modelling the Legal Analysis Methodology}
\newcommand{\DelPreparation}{}
\newcommand{\DelReaders}{system architects, business analysts, business staff, technical staff}
